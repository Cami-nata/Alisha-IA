...
try:
    from core.brain import get_brain, get_idle_watcher
    _brain = get_brain()
...
# ── VisionEngine ──────────────────────────────────────────────────────────────
try:
    from vision.vision_engine import get_vision_engine, enrich_query_with_vision
...
# ── AudioVisualSync ───────────────────────────────────────────────────────────
try:
    from avatar.audio_visual_sync import get_audio_visual_sync
...
_agent_loop = None
try:
    from core.agent_loop import AgentLoop as _AgentLoop
    _AGENT_LOOP_OK = True
except Exception:
    _AgentLoop = None
...
from avatar.tts_engine import speak
...
def _inicializar() -> None:
    ...
    try:
        from avatar.alisha_bridge import start_idle_loop
        start_idle_loop()
    ...
    from tools.pc_controller import iniciar_hotkey_bloqueo
...
def escribir_en_app():
    ...
    def _ejecutar():
        ...
        try:
            ...
            from tools.pc_controller import esta_bloqueado
...
def set_config():
    ...
    try:
        from avatar.tts_engine import TTSEngine
...
def set_lock():
    from tools.pc_controller import set_bloqueado
    data = request.json or {}
                ...
                if _BRAIN_OK and _brain:
                    ...
                    try:
                        ...
                        if titulo_ventana and "alisha" not in titulo_ventana.lower():
                            ...
                            from vision.vision_engine import detectar_rol
        ...
        def _hablar_y_señalar():
            ...
            try:
                if _AVS_OK and _avs:
                    ...
                    from avatar.tts_engine import speak as _speak_tts
                    _audio_iniciado.set()
