"""Configuración centralizada de Alisha IA — todas las variables de entorno y rutas."""
import os
...
# ── Optimización de RAM y modo cloud ─────────────────────────────────────────
PREFER_CLOUD = True       # Si True, usa modelos cloud (Gemini/Groq/Mistral) cuando hay internet
MAX_RAM_MB = 2048         # Límite de RAM en MB para modelos locales (Ollama)
OFFLINE_MODE = False      # Si True, fuerza uso de Ollama sin verificar internet
